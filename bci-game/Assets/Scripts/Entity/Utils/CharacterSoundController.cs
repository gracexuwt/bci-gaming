...
namespace Entity.Utils
{
    ...
    public class CharacterSoundController : MonoBehaviour
    {
        ...
        [Header("Volume")]
        [SerializeField, Range(0.0f, 1.0f)] public float footstepVolume = 0.8f;
        [SerializeField, Range(0.0f, 1.0f)] public float jumpVolume = 0.8f;
        [SerializeField, Range(0.0f, 1.0f)] public float landVolume = 0.8f;
        [SerializeField, Range(0.0f, 1.0f)] public float hurtVolume = 0.8f;
        [SerializeField, Range(0.0f, 1.0f)] public float deathVolume = 0.8f;
        [SerializeField, Range(0.0f, 1.0f)] public float meleeAttackVolume = 0.8f;
        [SerializeField, Range(0.0f, 1.0f)] public float rangeAttackVolume = 0.8f;
        [SerializeField, Range(0.0f, 1.0f)] public float pickupCoinVolume = 0.8f;
